...
namespace CoreERP.API.Controllers
{
    ...
    [ApiController]
    public class QuoteFutureController : Controller
    {
        private readonly IQuoteFutureRepository _QuoteRepository;

        public QuoteFutureController(IQuoteFutureRepository cuoteFutureRepository)
        {
            _QuoteRepository = cuoteFutureRepository;
        }
