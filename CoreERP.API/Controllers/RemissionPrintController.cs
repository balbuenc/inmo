...
namespace CoreERP.API.Controllers
{
    ...
    [ApiController]
    public class RemissionPrintController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        public RemissionPrintController(IWebHostEnvironment webHostEnviroment)
        {
        ...
        [HttpGet]
        [Route("DownloadRemission/{id}")]
        public async Task<FileStreamResult> DownloadInvoice(int id)
        {
            string mimeType = "";
            int extension = 1;
            var path = $"C:\\Users\\cbalbuena\\source\\repos\\Lugaro\\ReportDesign\\Remision.rdlc";
