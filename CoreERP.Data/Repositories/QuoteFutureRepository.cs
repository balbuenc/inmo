...
{
    public class QuoteFutureRepository : IQuoteFutureRepository
    {
        private SqlConfiguration _connectionString;

        public QuoteFutureRepository(SqlConfiguration connectionStringg)
        {
        ...
        public async Task<IEnumerable<Quote>> GetAllQuotes()
        {
            try
            {
                ...
                var sql = @"select vc.*, r.regla , m.mensaje,
                            ...
                            as comando
                            from imports.vconsulta_cliente_2 vc
                            ...
                            or (vc.meses_mora = r.mes_atraso and r.tipo = 'M'))
